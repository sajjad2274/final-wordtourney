...
namespace DTT.MinigameBase.LevelSelect
{
    ...
    public class LevelDatabase : ScriptableObject
    {
        ...
        public void SetLocked(int index, bool isLocked)
        {
            ...
            {
                PlayerPrefs.SetInt(GameHandler.Instance.tournamentCurrentPlayerData.tournamentName + "Level", PlayerPrefs.GetInt(GameHandler.Instance.tournamentCurrentPlayerData.tournamentName + "Level", 0)+1);
                PlayerPrefs.Save();
                GamePlayHandler.Instance.resultsUI.CheckTournamentLevelCompleted(); 


            }
            else if(GameHandler.Instance.progressData.levelCompleted < GameHandler.Instance.levels.Count-1&&!GameHandler.Instance.isTournament) GameHandler.Instance.progressData.levelCompleted++;
        ...
        private void Save()
        {
            ...
            PlayerPrefs.SetInt("levelsUnlocked", GameHandler.Instance.progressData.levelCompleted);
            PlayerPrefs.Save();
            CreatePath();
