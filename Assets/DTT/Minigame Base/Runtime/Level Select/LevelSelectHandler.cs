...
namespace DTT.MinigameBase.LevelSelect
{
    ...
    public abstract class LevelSelectHandler<TConfig, TResult, TMinigame> : LevelSelectHandlerBase where TMinigame : Object, IMinigame<TConfig, TResult>
    {
        ...
        {
            _levelDatabase.Load();
            selectedLevel = _levelDatabase.Data[GameHandler.Instance.progressData.levelCompleted];
        ...
        protected virtual void OnLevelSelected(LevelData levelData)
        {
            ...
            _minigame.StartGame(GetConfig());
            HideLevelSelect();
        }
        //public WordConnectConfigurationData GetConfigLevel() => game;
        /// <summary>
        ...
        protected virtual void OnMinigameFinished(TResult result)
        {
            ...
            int index = selectedLevel.levelNumber - 1;
            if(score<0)score= 0;
            ...
            if(selectedLevel.levelNumber < _levelDatabase.Data.Count)
            {
                _levelDatabase.SetLocked(selectedLevel.levelNumber, false);
            }
